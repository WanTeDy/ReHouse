...
namespace ReHouse.FrontEnd.Controllers
{
    public class SaleController : Controller
    {
        ...
        public ActionResult Flat()
        {
            ...
            var operation = new LoadFlatsOperation(tokenHash, 1, ConstV.ItemsPerPage, 0, 0, 0, (int)ParrentCategories.Flat, AdvertsType.Sale, false);
        ...
        public ActionResult House()
        {
            ...
            var operation = new LoadFlatsOperation(tokenHash, 1, ConstV.ItemsPerPage, 0, 0, 0, (int)ParrentCategories.House, AdvertsType.Sale, false);
            operation.ExcecuteTransaction();
            if (operation._category == null)
                return HttpNotFound();
            model.Adverts = operation._adverts;
        ...
        public ActionResult Homestead()
        {
            ...
            var operation = new LoadFlatsOperation(tokenHash, 1, ConstV.ItemsPerPage, 0, 0, 0, (int)ParrentCategories.Homestead, AdvertsType.Sale, false);
            operation.ExcecuteTransaction();
            if (operation._category == null)
                return HttpNotFound();
            ViewBag.NoElements = false;
        ...
        public ActionResult Commerce()
        {
            ...
            var operation = new LoadFlatsOperation(tokenHash, 1, ConstV.ItemsPerPage, 0, 0, 0, (int)ParrentCategories.Commerce, AdvertsType.Sale, false);
            operation.ExcecuteTransaction();
            if (operation._category == null)
                return HttpNotFound();
            ViewBag.NoElements = false;
        ...
        //[HttpPost]
        //public ActionResult Category(PageAndFilterModel pageAndFilter)
        //{
