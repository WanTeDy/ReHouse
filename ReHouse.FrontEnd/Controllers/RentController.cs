...
namespace ReHouse.FrontEnd.Controllers
{
    public class RentController : BaseController
    {
        ...
        public ActionResult Flat(int? id)
        {
            ...
            var operationFilter = new LoadFiltersOperation(tokenHash, AdvertsType.Rent, (int)ParrentCategories.Flat);
            ...
            var operation = new LoadFlatsOperation(tokenHash, 1, ConstV.ItemsPerPage, 0, 0, 0, 0, RentPeriodType.All, 0, categoryId, AdvertsType.Rent, false);
        ...
        public ActionResult House(int? id)
        {
            ...
            if (sessionModel != null)
                tokenHash = sessionModel.TokenHash;
            var operationFilter = new LoadFiltersOperation(tokenHash, AdvertsType.Rent, (int)ParrentCategories.House);
            operationFilter.ExcecuteTransaction();
            var model = new LoadAdvertsModel
            {
                Districts = operationFilter._districts,
        ...
        public ActionResult Homestead(int? id)
        {
            ...
            if (sessionModel != null)
                tokenHash = sessionModel.TokenHash;
            var operationFilter = new LoadFiltersOperation(tokenHash, AdvertsType.Rent, (int)ParrentCategories.Homestead);
            operationFilter.ExcecuteTransaction();
            var model = new LoadAdvertsModel
            {
                Districts = operationFilter._districts,
        ...
        public ActionResult Commerce(int? id)
        {
            ...
            if (sessionModel != null)
                tokenHash = sessionModel.TokenHash;
            var operationFilter = new LoadFiltersOperation(tokenHash, AdvertsType.Rent, (int)ParrentCategories.Commerce);
            operationFilter.ExcecuteTransaction();
            var model = new LoadAdvertsModel
            {
                Districts = operationFilter._districts,
        ...
        public ActionResult Load(PageAndFilterForAdvertsModel pageAndFilter)
        {
            ...
            var operation = new LoadFlatsOperation(tokenHash, pageAndFilter.PageNumber, ConstV.ItemsPerPage, pageAndFilter.DistrictId, pageAndFilter.PriceMin, pageAndFilter.PriceMax,
                pageAndFilter.TrimconditionId, pageAndFilter.RentPeriodType, pageAndFilter.UserId, pageAndFilter.CategoryId, AdvertsType.Rent, false);
            operation.ExcecuteTransaction();
