...
{
    public class SaleController : BaseCabinetController
    {
        [HttpGet]
        public ActionResult Flat(int? id)
        {
            ...
            var operationFilter = new LoadFiltersOperation(sessionModel.TokenHash, AdvertsType.Sale, (int)ParrentCategories.Flat);
            ...
            var operation = new LoadFlatsOperation(sessionModel.TokenHash, 1, ConstV.ItemsPerPageAdmin, 0, 0, 0, 0, RentPeriodType.All, 0, categoryId, AdvertsType.Sale, false, true);
        ...
        public ActionResult House(int? id)
        {
            ...
            var operationFilter = new LoadFiltersOperation(sessionModel.TokenHash, AdvertsType.Sale, (int)ParrentCategories.House);
            operationFilter.ExcecuteTransaction();
            var model = new LoadAdvertsModel
            {
                Districts = operationFilter._districts,
        ...
        public ActionResult Homestead(int? id)
        {
            ...
            var operationFilter = new LoadFiltersOperation(sessionModel.TokenHash, AdvertsType.Sale, (int)ParrentCategories.Homestead);
            operationFilter.ExcecuteTransaction();
            var model = new LoadAdvertsModel
            {
                Districts = operationFilter._districts,
        ...
        public ActionResult Commerce(int? id)
        {
            ...
            var operationFilter = new LoadFiltersOperation(sessionModel.TokenHash, AdvertsType.Sale, (int)ParrentCategories.Commerce);
            operationFilter.ExcecuteTransaction();
            var model = new LoadAdvertsModel
            {
                Districts = operationFilter._districts,
        ...
        public ActionResult Load(PageAndFilterForAdvertsModel pageAndFilter)
        {
            ...
            var operation = new LoadFlatsOperation(sessionModel.TokenHash, pageAndFilter.PageNumber, ConstV.ItemsPerPageAdmin, pageAndFilter.DistrictId, pageAndFilter.PriceMin, pageAndFilter.PriceMax,
                pageAndFilter.TrimconditionId, pageAndFilter.RentPeriodType, pageAndFilter.UserId, pageAndFilter.CategoryId, AdvertsType.Sale, false, true);
            operation.ExcecuteTransaction();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var op6 = new LoadSeoParamOperation(sessionModel.TokenHash, ConstV.DetailAction, CurrentController, "/" + CurrentController + "/" + ConstV.DetailAction + "/" + operation._advert.Id, operation._advert.Id.ToString(), true);
