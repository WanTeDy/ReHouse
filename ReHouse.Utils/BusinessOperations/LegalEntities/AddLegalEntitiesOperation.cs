...
{
    public class AddLegalEntitiesOperation : BaseOperation
    {
        public Contractor LegalEntity { get; set; }
        public String TokenHash { get; set; }

        public AddLegalEntitiesOperation(Contractor legalEntity, string tokenHash)
        {
            LegalEntity = legalEntity;
            TokenHash = tokenHash;
            RussianName = "Дабавление/Регистрация партнера";
        }
